...
//Bind a Popup to the Marker    (city, state, population)

// To add data from each object in the cities array, use bindPopup() method on the marker() function. To do this, add HTML code inside the parentheses of the bindPopup() method.
